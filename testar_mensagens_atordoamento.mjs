...
async function testAttackMessage() {
  ...
  console.log(
    "\n✅ Mensagem de aplicação do Atordoamento correta."
  );

  console.log(
    "✅ Mensagem da ação atordoada correta."
  );
}
...
async function testEstadoMessage() {
  ...
  console.log(
    "\n✅ Atordoamento aparece corretamente no !estado."
  );
}
...
console.log(
  "\n💫 TODOS OS TESTES DE MENSAGEM DE ATORDOAMENTO PASSARAM."
);
